...
public class SystemBasicController {
   ...
   @RequestMapping(value = "/role/{rid}", method = RequestMethod.DELETE)
    ...
    public Map<String, Object> menuTree(@PathVariable Long rid) {
        ...
        List<XhxMenu> menus = menuService.menuTree();
        map.put("menus", menus);
    ...
    public List<XhxRole> allRoles() {
        return roleService.roles();
    }

    @RequestMapping(value = "/dep", method = RequestMethod.POST)
    public Map<String, Object> addDep(XhxDepartment department) {
        Map<String, Object> map = new HashMap<>();
    ...
    public List<XhxDepartment> getDepByPid(@PathVariable Long pid) {
